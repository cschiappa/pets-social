...
import 'package:pets_social/core/widgets/comment_card.dart';
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              InkWell(
                onTap: () async {
                  await ref.read(postRepositoryProvider).postComment(widget.snap['postId'], _commentController.text, profile.profileUid, profile.username, profile.photoUrl ?? "", widget.snap['likes']);
                  setState(() {
