...
import 'package:pets_social/core/widgets/bone_animation.dart';
import 'package:pets_social/core/widgets/fish_animation.dart';
                  ...
                  child: CarouselSlider(
                    ...
                    items: [
                      ...
                      FishAnimation(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await postRepository.giveFishToPost(widget.postId, widget.profileUid, widget.fish);
                          },
                          child: Image.asset(
                      ...
                      LikeAnimation(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await postRepository.likePost(widget.postId, widget.profileUid, widget.likes);
                          },
                          child: Image.asset(
                      ...
                      BoneAnimation(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await postRepository.giveBoneToPost(widget.postId, widget.profileUid, widget.bones);
                          },
                          child: Image.asset(
