...
import 'package:pets_social/core/widgets/carousel_slider.dart';
import 'package:pets_social/core/widgets/like_animation.dart';
import 'package:pets_social/core/widgets/save_post_animation.dart';
import 'package:pets_social/core/widgets/text_field_input.dart';
import 'package:pets_social/core/widgets/video_player.dart';
...
class _PostCardExpState extends ConsumerState<PostCardExp> {
  ...
  Future<String> updatePost(StateSetter setState) async {
    ...
    String res = await postRepository.updatePost(
          ...
          children: [
            Stack(
              ...
              children: [
                ...
                GestureDetector(
                  onDoubleTap: () async {
                    await postRepository.likePost(widget.snap['postId'], profile.profileUid, widget.snap['likes']);
                    setState(() {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: SavePostAnimation(
                                isAnimating: profile.savedPost.contains(widget.snap['postId']),
                                smallLike: true,
                                child: InkWell(
                                  onTap: () async {
                                    await postRepository.savePost(widget.snap['postId'], profile.profileUid, profile.savedPost).then((_) {
                                      setState(() {
                                  ...
                                  child: Icon(
                                    (profile.savedPost.contains(widget.snap['postId'])) ? Icons.bookmark : Icons.bookmark_border,
                                    color: theme.colorScheme.primary,
                                  ),
                                ),
                              ),
                                                        ...
                                                        builder: (context) {
                                                          return AlertDialog(
                                                            ...
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () {
                                                                  postRepository.deletePost(widget.snap['postId']);
                                                                  Navigator.of(context).pop();
                                                                },
